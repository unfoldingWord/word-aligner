...
_Object$keys(_verseObjects).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;

  _Object$defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _verseObjects[key];
    }
  });
});
...
_Object$keys(_array).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
...
var addVerseObjectToAlignment = exports.addVerseObjectToAlignment = function addVerseObjectToAlignment(verseObject, alignment) {
  if (verseObject.type === 'milestone' && verseObject.children.length > 0) {
    ...
    var _wordObject2 = VerseObjectUtils.alignmentObjectFromVerseObject(verseObject);
...
var populateOccurrencesInWordObjects = exports.populateOccurrencesInWordObjects = function populateOccurrencesInWordObjects(words) {
  ...
  return words.map(function (wordObject) {
    ...
    if (wordText) {
      ...
      wordObject.occurrence = VerseObjectUtils.getOccurrence(words, index++, wordText);
      wordObject.occurrences = VerseObjectUtils.getOccurrences(words, wordText);
      return wordObject;
    }
    return null;
