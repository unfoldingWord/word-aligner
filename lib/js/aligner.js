...
exports.getBlankAlignmentDataForVerse = exports.generateWordBank = exports.generateBlankAlignments = exports.verseHasAlignments = exports.unmerge = exports.orderAlignments = exports.indexOfMilestone = exports.indexOfFirstMilestone = exports.merge = undefined;
...
var unmerge = exports.unmerge = function unmerge(verseObjects, alignedVerse) {
  ...
  try {
    for (var _iterator3 = (0, _getIterator3.default)(verseObjects), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      VerseObjectUtils.addVerseObjectToAlignment(verseObject, _alignment2);
    }
  } catch (err) {
